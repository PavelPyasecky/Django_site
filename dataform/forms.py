...
class DataForm(forms.Form):
    name = forms.CharField(label="Имя",
                           min_length=3,
                           max_length=32,
                           widget=forms.TextInput(attrs={"class": "form-control form-text required",
    ...
    email = forms.EmailField(label="Email",
                             ...
                             widget=forms.TextInput(attrs={"class": "form-control form-text required",
                                                           ...
                                                           "placeholder": "ivan1982ivanovich@mail.ru"})
                             )
    ...
    mes = forms.CharField(label="Сообщение",
                          widget=forms.Textarea(attrs={"class": "form-control form-textarea required",
